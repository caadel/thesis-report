...
\begin{flushleft}
    ...
    \it \LARGE - an investigation of the experiences and opinions of developers in the industry
\end{flushleft}
\null
\vfill
...
During the project, two surveys were conducted. The first survey asked mobile application developers from companies in different countries about things such as their knowledge of, experience with, and opinions of PWA. The second survey asked similar questions but was instead answered by lecturers in higher education in Sweden only.
...
\begin{figure}[h]%
	\centering
	\subfloat[Native]{\includegraphics[height=7cm]{img/Other/twitter_native.jpg}}%
	$\,$
	\subfloat[PWA]{\includegraphics[height=7cm]{img/Other/twitter_pwa.jpg}}%
	$\,$
	\subfloat[Web]{\includegraphics[height=7cm]{img/Other/twitter_web.jpg}}%
