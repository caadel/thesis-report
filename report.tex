...
\newcommand\BackgroundPic{
    \put(-2,-3){
    \includegraphics[keepaspectratio,scale=0.3]{Report/img/Other/lnu_etch.png} % Background picture
    }
}
\newcommand\BackgroundPicLogo{
    \put(30,740){
    \includegraphics[keepaspectratio,scale=0.10]{Report/img/Other/logo.png} % Logo in upper left corner
    }
}
...
\begin{figure}[h]%
	\centering
	\subfloat[Laptop view]{\fbox{\includegraphics[height=5.2cm]{Report/img/Other/responsive_desktop.png}}}%
	\quad
	\subfloat[Smartphone view]{\fbox{\includegraphics[height=5.2cm]{Report/img/Other/responsive_mobile.jpg}}}%
...
\begin{figure}[h]%
	\centering
	\includegraphics[height=3cm]{Report/img/Other/struct_webapp.png}
...
\begin{figure}[h]%
	\centering
	\includegraphics[height=3cm]{Report/img/Other/struct_hybrid.png}
...
\begin{figure}[h]%
	\centering
	\includegraphics[height=6cm]{Report/img/Other/struct_pwa.png}
...
\subsubsection{Dev survey questions}
...
Just like for the developer survey, the final part is not for asking questions but is instead for feedback. Of note is that the education survey is completely separate from the dev survey, which is why some questions appear duplicated. 
...
ESQ 16 & What is your opinion on PWA as a development technique today? \\
ESQ 17 & Do you think PWA should be included in the curriculum? \\
\hline
\end{tabular}
...
\subsubsection{Participating countries - dev survey}
...
\subsubsection{Selection process - dev survey}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq1.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq3.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq4.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq5.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq6.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq7.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq8.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq9.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq10.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq11.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq12.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq13.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq14.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq15.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq16.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq17.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq18.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq19.png}
...
\subsubsection{Part 1 - Personal Details}
This part of the survey was not aimed at directly answering any of the research questions, just like the first part of the Dev survey. The questions asked in this part were for the purpose of enabling more in-depth analysis and discussion and to help identify potential biases. Although since the number of responses was so low, this is not really possible in this case.

\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq1.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq3.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq4.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq5.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq6.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq7.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq8.png}
...
\section{Analysis}
In the analysis you turn your data in to evidence(strong) or arguments(weaker). You can choose different ways to organize this chapter. Say that you have conducted a controlled experiment. In that experiment you use hypothesis testing. In the analysis you perform statistical analysis on your data, apply various test, create box plots or descriptive statistics. \\

\noindent If you performed a systematic literature review you can also do statistical analyses, but the analysis may also use other methods to derive arguments. \\

\noindent What conclusions can you draw from the results? It is important that you don’t draw any conclusions that cannot be backed up by your data. Consider using statistical tests to back up your claims if it is feasible with the data you have. You can read about statistical testing \href{https://coursepress.lnu.se/subject/thesis-projects/statistical-testing/}{here}. \\

\noindent Use your problems and the questions to structure. Try to provide arguments or evidence in your data. Often it is not a definitive yes or no, shades of gray more frequent. Sometimes data can be interpreted in different ways. Ethics is important. You often find bias in this part. You look for evidence to support your opinion! \textbf{Stay away from that!} Remember that finding out that something doesn’t work is also knowledge. Never exaggerate the importance and validity. Be honest in your presentation.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_1.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_2.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_3.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_4.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_5.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_6.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_7.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_8.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/dsq20_9.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_1.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_2.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_3.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_4.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_5.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_6.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_7.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_8.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=10cm]{Report/img/Results/esq9_9.png}
